...
import { 
    faEnvelope, faBook, faPlusSquare,
    faSearch, faEllipsisH, faFile,
    faDotCircle, faTachometerAlt, faCopy, 
    faTh, faAngleRight, faChartPie, faTree, 
    faEdit, faAngleLeft, faTable, faCalendarAlt, 
    faImage, faColumns 
        ...
        <Fragment>
            ...
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="../../index3.html" className="brand-link">
                    <img src={`${imgPath}AdminLTELogo.png`} alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{ opacity: '.8' }} />
                ...
                <div className="sidebar">
                    ...
                    <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div className="image">
                            <img src={`${imgPath}user2-160x160.jpg`} className="img-circle elevation-2" alt="User Image" />
                        </div>
                        <div className="info">
                                ...
                                <ul className="nav nav-treeview">
                                    ...
                                    <li className="nav-item">
                                        ...
                                        <ul className="nav nav-treeview">
                                            <li className="nav-item">
                                                <a href="#" className="nav-link">
                                                    <FontAwesomeIcon icon={faDotCircle} className="nav-icon" />
                                                    <p>Level 3</p>
                                                </a>
                                            </li>
                                            <li className="nav-item">
